...
@TableName("`enterprise_text_field_value`")
@ApiModel(value = "EnterpriseTextFieldValue对象", description = "企业字段值表")
public class EnterpriseTextFieldValue implements Serializable {
    ...
    @ApiModelProperty(value = "企业字段id")
    private String enterpriseTextFieldId;
    ...
    @ApiModelProperty(value = "验证类型（-1：不验证, 0：统一社会信用编码，1：身份证，2：邮箱，3：座机，4：手机号，5：网站）")
